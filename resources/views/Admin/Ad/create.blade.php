            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    ...
                    <div class="am-u-lg-3 tpl-index-settings-button">
                        <button class="page-header-button" type="button"><span class="am-icon-paint-brush"></span> 设置</button>
                    </div>
                </div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="" method="post" enctype="" class="am-form tpl-form-border-form">
								...
								<div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-12">
                                            <input type="text" readonly=""   name="adesc" id="user-name" value="{{$uid}}" class="tpl-form-input am-margin-top-xs">
                                    ...
                                    <div class="am-form-group">
                                        <label class="am-u-sm-12 am-form-label  am-text-left" for="user-weibo">请上传广告图片 <span class="tpl-form-line-small-title">Images</span></label>
                                        <div class="am-u-sm-12 am-margin-top-xs">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                    <img alt="" src="assets/img/a5.png">
                                                </div>
                                                <button style="button" class="am-btn am-btn-danger am-btn-sm " type="button">
    <i class="am-icon-cloud-upload"></i> 请上传广告图片</button>
                                                <input type="file" name="aimg" multiple="" id="doc-form-file">
                                            </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-12">
                                            <input type="text" id="jine" name="aprice" placeholder="" class="am-margin-top-xs" id="user-weibo">
                                            <div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-12 am-u-sm-push-12">
                                            <button class="am-btn am-btn-primary tpl-btn-bg-color-success " type="button">提交</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
